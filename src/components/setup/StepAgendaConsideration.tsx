...
const MOCK_ALL_CASES = [
    { id: 1, fileNo: '68/0001', name: 'นายข้าวมัน ไก่ทอด' },
    { id: 2, fileNo: '68/0002', name: 'นายข้าวเหนียว หมูปิ้ง' },
    { id: 3, fileNo: '68/0003', name: 'นางคู่ เสื้อ หาว' },
    { id: 4, fileNo: '68/0004', name: 'นางสาวไก่ทอด น้ำปลา', selectedAgenda: 'วาระที่ 4' },
];

// --- Mock Data (รายการในวาระ) ---
...
const MOCK_DIALOG_DATA = [
    { id: 1, fileNo: '2568/0001', name: 'นายข้าวมัน ไก่ทอด', asset: 'เงินสด จำนวน 100,000 บาท', amount: '100,000.00', status: 'seize', note: '' },
