...
const HtmlContent = ({ html }: { html: string }) => {
    return (
        <div
            ...
            style={{
                display: '-webkit-box',
                WebkitLineClamp: 2, // ตัดคำเมื่อเกิน 2 บรรทัด
                    ...
                    <Stack direction={{ xs: 'column', md: 'row' }} justifyContent="space-between" alignItems={{ xs: 'flex-start', md: 'center' }} mb={4} gap={2}>
                        <Box>
                            <Typography variant="h5" fontWeight={800} color="#1e293b" gutterBottom>
                                การประชุมคณะกรรมการตรวจสอบทรัพย์สิน
                            </Typography>
                            <Typography variant="body2" color="text.secondary">
                                รายการนำเสนอและสถานะการพิจารณาตรวจสอบทรัพย์สิน
                            </Typography>
                        </Box>
                        <Button
                            variant="contained"
